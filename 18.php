...
<!-- div id="mpanel2">
  <div style="display: inline-block; float: left;">
    <input type="radio" name="P1" value="R">
    R<br>
    <input type="radio" name="P1" value="Y">
    Y<br>
    <input type="radio" name="P1" value="G">
    G<br>
  </div>
  <div style="display: inline-block; float: left;">
    <input type="radio" name="P2" value="R">
    R<br>
    <input type="radio" name="P2" value="Y">
    Y<br>
    <input type="radio" name="P2" value="G">
    G<br>
  </div>
  <div style="display: inline-block; float: left;">
    <input type="radio" name="P3" value="R">
    R<br>
    <input type="radio" name="P3" value="Y">
    Y<br>
    <input type="radio" name="P3" value="G">
    G<br>
  </div>
  <div style="display: inline-block; float: left;">
    <input type="radio" name="P4" value="R">
    R<br>
    <input type="radio" name="P4" value="Y">
    Y<br>
    <input type="radio" name="P4" value="G">
    G<br>
  </div>
</div-->
<script src="https://code.jquery.com/jquery-3.3.1.js"></script>
<script type="text/javascript">
$("#mpanel2 [type=radio]").click(function() 
{
	var name = this.name;
...
function redExcept(name)
{
	$("#mpanel2 [type=radio]").each(function(index) 
	{
...
//		url: "https://openclipart.org/download/82549/blue-circle.svg",
		url: 'data:image/svg+xml;charset=utf-8,' + getSVG(angle, "GGRRRRRR"),
